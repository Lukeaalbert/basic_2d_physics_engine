...
This repo contains a 2d physics engine built from scratch that simulates gravity and the collision of particles. It uses SFML to render the visals. The main.cpp provides sample execution and renders balls being "shot" from a point inside a container (see demo video).
